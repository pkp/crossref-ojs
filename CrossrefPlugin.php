...
class CrossrefPlugin extends GenericPlugin implements IDoiRegistrationAgency
{
    ...
    private function getValidationMessages(Publication $publication): array
    {
        return [
            ...
            'onlineIssn.required_without' => __('plugins.generic.crossref.onlineIssn.requiredWithout'),
            'printIssn.required_without' => __('plugins.generic.crossref.printIssn.requiredWithout'),
        ];
    }
    ...
    * @return array
    */
    private function formatErrors($array): array
    {
        $values = [];
